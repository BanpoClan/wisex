...
//加载datatable
wisex.grid.prototype.load = function () {
...
wisex.grid.prototype.getSelectedRow = function () {
    var _this = this;
    var _grid = $("#" + _this.id);
...
//获取datatable所有选中行的数据
wisex.grid.prototype.getSelectedRows = function () {
    var _this = this;
    var _grid = $("#" + _this.id);
    var selectedRows = [];
...
//重新加载
wisex.grid.prototype.reload = function () {
